...
e(\mathrm{HK}, j
\, || \, R_j^{new} \, \oplus \, \mathrm{hash}(\mathrm{ECDH}(r_j, R_i)) \, || \, 
...
and obtains $q \, || \, R \, || \, \mathrm{conv\_digest} =
...
\item Participant $P_j$ computes a new conversation digest
$\mathrm{new\_digest} = \mathrm{hash}(m) \, \oplus \, \mathrm{conv\_digest}$ and tests if
$\mathrm{new\_digest} = \mathrm{conv\_digest}$. If this test fails, he/she raises
a Bad\_DIGEST exception and goes no further. If the test succeeds, he/she sets
$\mathrm{conv\_digest} = \mathrm{new\_digest}$.
